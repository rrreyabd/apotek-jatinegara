...
<body class="font-Interflex relative">
    
    {{-- SIDEBAR START --}}
    <nav class="bg-white p-8 w-[20%] shadow-md absolute left-0 top-0 h-full z-10 shadow-semiBlack -translate-x-80 transition-transform duration-300 ease-in-out flex flex-col gap-4" id="sidebar">
