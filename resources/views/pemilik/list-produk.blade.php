    ...
    <main class="p-10 font-Inter bg-plat min-h-[100vh] h-full" id="mainContent">
        ...
        <div class="flex flex-col gap-8 mt-10">
            <div class="md:flex justify-between">
                ...
                <a href="/owner/tambah-produk" class="px-6 py-2.5 rounded-lg bg-mainColor text-white font-semibold">
                ...
                <table id="myTable" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$i + 1}}</td>
                            <td>
                                <span class="font-bold">Paracetamol 500 mg</span>
                            </td>
                            <td>14</td>
                            ...
                            <td>
                                    <a href="edit-produk" class="p-2 bg-secondaryColor rounded mx-2"><i
