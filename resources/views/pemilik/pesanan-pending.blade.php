                ...
                <table id="myTable" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>BCA</td>
                            <td>
                                <button onclick="showPaymentSS()" target="_blank" class="underline">Screenshot123.jpg</button>
                                <div class="absolute w-full h-screen top-0 left-0 flex justify-center items-center backdrop-brightness-[.25] z-10 hidden" id="ModalBuktiPembayaran">
                                    <div class="bg-white rounded-xl shadow-md">
                                        ...
                                        <img src="{{ asset('img/obat1.jpg') }}" alt="" class="h-[60vh] w-fit relative p-4">
                                    </div>
                                </div>
                            </td>
                            <td>
