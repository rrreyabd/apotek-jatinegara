        ...
        <div class="bg-white w-[35vw] h-[60vh] rounded-3xl shadow-xl flex flex-col justify-center items-center gap-6 px-16 py-4 text-center">
            ...
            <?php if(session('status') == 'verification-link-sent'): ?>
                <div class="text-sm text-mainColor mt-1 ms-3 mb-0 text-center">
                    <?php echo e(__('Link Verifikasi Baru Telah Dikirimkan, Silahkan Cek Email Yang Anda Daftarkan!')); ?>
...
</html><?php /**PATH D:\Alwin-Liufandy\School\SEM-3\MSBD\ApotekJatiNegara\apotek-msbd\resources\views/user/verify-email.blade.php ENDPATH**/ ?>