            ...
            <div class="flex flex-wrap justify-between gap-0 lg:gap-[65px]">
                ...
                <a href="" class="mb-7 h-64 w-[220px] shadow-md border-2 shadow-semiBlack rounded-lg p-4 flex flex-col bg-white">
                    ...
                    <center class="relative">
                        ...
                        <img src="<?php echo e(asset('img/obat1.jpg/')); ?>" width="150px" alt="" draggable="false">    
                    </center>
...
</script><?php /**PATH D:\Alwin-Liufandy\School\SEM-3\MSBD\ApotekJatiNegara\apotek-msbd\resources\views/user/components/index/last-purchased.blade.php ENDPATH**/ ?>